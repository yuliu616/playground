...
export class DateHelper {
  ...
  public static presentDate(value: Date): string {
    if (value) {
      // return dayjs(value).format(DateFormat.DATE_TIME_LONG);
      return dayjs(value).format(DateFormat.DATE_ONLY_CHINESE);
    } else {
      return '';
    }
  }
  ...
  public static presentDateTime(value: Date): string {
    if (value) {
      // return dayjs(value).format(DateFormat.DATE_TIME_LONG);
      return dayjs(value).format(DateFormat.DATE_TIME_WITHOUT_SEC);
    } else {
      return '';
    }
  }
